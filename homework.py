...
class Training:
    ...
    def __init__(self, action: int, duration: float, weight: float) -> None:
        ...
        self.action = check_data(action)
        self.duration = check_data(duration)
        self.weight = check_data(weight)
...
class Swimming(Training):
    ...
    def __init__(self, action: int, duration: float, weight: float,
        ...
        super().__init__(action, duration, weight)
        self.length_pool = check_data(length_pool)
        self.count_pool = check_data(count_pool)
